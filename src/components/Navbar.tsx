      ...
      <div className="w-full flex items-end justify-between">
        ...
        <div className="hidden lg:flex items-end gap-8">
          ...
          <div className="flex items-end gap-6">
            ...
            <a href="https://www.facebook.com/CreativeEdinburgh/" className="text-gray-600 hover:text-tertiary transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
              </svg>
            </a>
            <a href="https://www.instagram.com/creativeedinburgh/" className="text-gray-600 hover:text-tertiary transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/creativeedinburgh/" className="text-gray-600 hover:text-tertiary transition-colors duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="31.866" height="40.143" viewBox="0 0 31.866 40.143"><g id="Grupo_1225" data-name="Grupo 1225" transform="translate(0 -0.001)"><g id="Grupo_967" data-name="Grupo 967" transform="translate(0 0)"><g id="Grupo_969" data-name="Grupo 969" transform="translate(0 26.532)"><g id="Grupo_967-2" data-name="Grupo 967" transform="translate(0)">
                <path id="Caminho_254" data-name="Caminho 254" d="M5382.428,4612.549h-4.6a13.6,13.6,0,0,1,13.611-13.611v4.6a9.009,9.009,0,0,0-9.01,9.009Z" transform="translate(-5377.826 -4598.938)"></path></g> <g id="Grupo_968" data-name="Grupo 968" transform="translate(18.254)"><path id="Caminho_255" data-name="Caminho 255" d="M5516.053,4612.549h-4.6a9.009,9.009,0,0,0-9.01-9.009v-4.6a13.6,13.6,0,0,1,13.611,13.611Z" transform="translate(-5502.441 -4598.938)"></path></g></g> <g id="Grupo_973" data-name="Grupo 973" transform="translate(6.076)"><g id="Grupo_971" data-name="Grupo 971" transform="translate(0 0)"><g id="Grupo_970" data-name="Grupo 970"><path id="Caminho_256" data-name="Caminho 256" d="M5439.015,4427.666h-4.6a5.256,5.256,0,1,0-10.511,0h-4.6a9.857,9.857,0,1,1,19.715,0Z" transform="translate(-5419.3 -4417.808)"></path></g>
                  <path id="Caminho_257" data-name="Caminho 257" d="M5434.413,4516.8a5.256,5.256,0,1,1-10.511,0h-4.6a9.857,9.857,0,1,0,19.715,0Z" transform="translate(-5419.3 -4502.296)"></path></g> <g id="Grupo_972" data-name="Grupo 972" transform="translate(7.536 9.857)"><rect id="Retângulo_584" data-name="Retângulo 584" width="4.643" height="4.643" rx="2.321"></rect></g></g></g></g></svg>
            </a>
          </div>
        </div>
      </div>
