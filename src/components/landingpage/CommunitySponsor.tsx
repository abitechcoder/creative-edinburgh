      ...
      <div className="relative container mx-auto z-15 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-auto grid-flow-row dense px-4">
        ...
        <div className="h-auto">
          <SponsorCard
            ...
            price="SLE20,000"
            benefits={[
              "Exclusive branding - a Headline Sponsor spotlight and logo on the Salone Bizness Directory website and a bespoke introduction in a monthly newsletter to our members, which has an open rate of more than 40%.",
              "Opportunity for self-promotion through social posts, Instagram takeovers and event speaking opportunities.",
              "Guest participation at an event with Salone Bizness Directory to showcase your brand, invite your staff or/and benefit from a speaking slot.",
              "Co-presenting the Salone Bizness Directory Awards or Summer Party with the Salone Bizness Directory team.",
              "Introductory promotional video at the Salone Bizness Directory Awards Ceremony and Summer Party.",
              "15 tickets to the annual Awards Ceremony and Summer Party.",
              "A bespoke creative workshop tailored to your organisation’s needs, co-curated by the Salone Bizness Directory team.",
            ]}
            buttonText="EMAIL US"
          />
        </div>
        ...
        <div className="h-auto">
          <SponsorCard
            ...
            price="SLE10,000"
            benefits={[
              "Dedicated Community Sponsor spotlight on the Salone Bizness Directory website, detailing your company.",
              "Exclusive introduction in the newsletter to our members, which has an open rate of more than 40%.",
              "Showcase your business with sponsor guest invitations and branding touchpoints at Salone Bizness Directory’s well-attended events.",
        ...
        <div className="h-auto">
          <SponsorCard
            ...
            heading="Sponsorship of one of the 10 Salone Bizness Directory Awards, and supporting five months of professional mentoring to the individual winners. Other benefits include:"
            benefits={[
              "Co-presenting the Award with a previous winner.",
              "Branding across Salone Bizness Directory event pages, content and communications.",
              "4 complimentary Award ceremony tickets for your team.",
              "Your logo included on the Salone Bizness Directory website, social media, newsletter, and communications.",
        ...
        <div className="h-auto">
          <SponsorCard
            ...
            additionalBenefits={[
              "Branding and logo across Salone Bizness Directory website, newsletter, and social media platforms.",
        ...
        <div className="h-auto">
          <SponsorCard
            ...
            heading="As an exclusive sponsor of Creative Circles, Salone Bizness Directory's flagship monthly networking event, you receive access to an engaged, socially conscious group of freelancers, businesses, and organisations. As well as increased brand awareness and access to different communities of creatives in the Edinburgh city region."
            benefits={[
