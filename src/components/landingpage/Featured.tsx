...
const sectors: SectorType[] = [
  ...
  // },
  {
    ...
    description:
      "Support fintech startups revolutionizing financial inclusion.",
  },
  {
    id: 4,
    image: Creative,
  ...
  return (
    <section className="py-15 lg:py-20 bg-secondary">
      <div className="container mx-auto  px-4">
        <h2
          className={`${styles.heading1} lg:max-w-[70%] lg:mx-auto text-white text-center mb-8`}
        >
          Featured Opportunities
        </h2>
        <p className="text-xl lg:text-3xl font-bold text-white text-center">
          Sierra Leone's High-Growth Sectors
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mt-8 lg:mt-16">
          {sectors.map((sector) => (
            <div
              key={sector.id}
              className="bg-white h-[300px] lg:h-[450px] relative rounded-lg lg:p-12 lg:gap-8 text-center"
            >
              <Image
                alt={sector.image}
                src={sector.image}
              ...
              />
              <div
                className="bg-black/70 w-full h-full rounded-lg absolute top-0 left-0 z-10 flex flex-col items-center justify-center gap-6
             p-6"
              >
        ...
        <div className="w-full pt-10 lg:pt-20 flex flex-col items-center gap-4 lg:gap-8">
          <h3 className="text-center text-2xl lg:text-4xl font-bold text-white">
