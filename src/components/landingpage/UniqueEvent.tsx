import { UniqueEventsImage } from "../../../public";
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center ">
      <UniqueEventCard
        ...
        description={[
          ...
          "Hosted in-person and online, Salone Bizness Directory events span the city’s creative industries, helping you stay connected, build skills and knowledge and get inspired.",
        ]}
