...
import { amy, brian, bruce, charlie, christina, janice, jessica, marie, michaela, nicki } from "../assets";
...
interface BoardMember {
  ...
  const boardMembers: BoardMember[] = [
    ...
    },
    {
        name: "NICKI LUNDY",
        image: nicki,
        description: "Nicki Lundy is a media relations, corporate communications and brand building professional who has worked as a journalist and magazine editor too. Currently freelance, we welcomed Nicki to our Board in 2018. Talk to Nicki about all things relating to PR, communications strategy, brand and adapting to change.",
        role: ""
    },
    {
        name: "CHARLIE BELL",
...
const Board = () => {
  ...
  return (
    <motion.section 
      ...
      className="text-black py-16 px-8 flex justify-end flex-col items-end md:px-16"
    >
      <div className="md:w-[42%] w-full my-40">
        <h2 className="text-4xl font-bold mb-4">Board</h2>
