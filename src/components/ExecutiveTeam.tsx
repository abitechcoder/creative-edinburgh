    ...
    >
      <div className="md:w-[50%] w-full my-0 lg:my-20 flex flex-col gap-4 lg:gap-8">
        ...
        <p className="text-xl leading-relaxed">
          Our Team are based in Freetown Sierra Leone, but we pop up in various locations around town.
          ...
          Come along to one of our regular events to <a href="mailto:connect@sierraleonebusinessmarkit.com" className="text-tertiary">
