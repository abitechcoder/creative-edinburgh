    ...
    <footer className="bg-[#0D0B18] text-white py-12 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <a
            href="https://www.google.com/maps/dir//CodeBase+Ltd,+37a+Castle+Terrace,+E…7991a24de13:0x5727e05b4321b9f6!2m2!1d-3.2017395!2d55.9471596!3e2?hl=pt-PT"
            target="_blank"
            className="mt-2 text-white cursor-pointer font-medium w-[65%]"
          >
            Creative Edinburgh LTD c/o CodeBase 37a Castle Terrace Edinburgh EH1
            2EL
          </a>
        </div>
        ...
        <div>
          <h2 className="text-[#b0a3f9] font-bold text-lg">
            GENERAL ENQUIRIES
          </h2>
          ...
          <div className="mt-14">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.youtube.com/@creativeedinburgh1765/featured"
                className="hover:text-yellow-400 transition-colors duration-300 ease-in-out"
              >
                <FaVimeoV size={24} />
              </a>
        ...
        <div>
          <h2 className="hover:text-yellow-400 transition-all duration-300 ease-in-out font-medium cursor-pointer text-[#b0a3f9] text-md">
            Terms Of Use
          </h2>
          <p className="mt-2">
            <a
              href="#"
              className="hover:text-yellow-400 transition-all duration-300 ease-in-out font-medium cursor-pointer text-[#b0a3f9] text-md"
            >
              Cookie Policy
            </a>
          </p>
        ...
        <div className="text-md">
          <p className="hover:text-yellow-400 transition-all duration-300 ease-in-out font-medium cursor-pointer text-[#b0a3f9]">
      ...
      <div className="max-w-7xl mx-auto mt-12 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-md">© {currentYear} Creative Edinburgh LTD</p>
